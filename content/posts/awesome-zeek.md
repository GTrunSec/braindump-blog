+++
title = "Awesome Zeek"
lastmod = 2020-10-22T17:31:39-07:00
draft = false
...
- <span class="section-num">5</span> [Zeek Script](#zeek-script)
    ...
    - <span class="section-num">5.3</span> [ZeeK Script DNS<code>[0/0]</code>](#zeek-script-dns)
        - <span class="section-num">5.3.1</span> [<span class="org-todo done DONE">DONE</span> [ ] [] https://github.com/hhzzk/dns-tunnels](#https-github-dot-com-hhzzk-dns-tunnels):DNS:
        - <span class="section-num">5.3.2</span> [<span class="org-todo done DONE">DONE</span> [ ][dns axfr query ] https://github.com/srozb/dns\_axfr](#dns-axfr-query-https-github-dot-com-srozb-dns-axfr):DNS:
        - <span class="section-num">5.3.3</span> [<span class="org-todo done DONE">DONE</span> https://github.com/corelight/top-dns](#https-github-dot-com-corelight-top-dns):LEARN:Necessary:
    - <span class="section-num">5.4</span> [Zeek Script Conn<code>[3/3]</code>](#zeek-script-conn)
        - <span class="section-num">5.4.1</span> [<span class="org-todo done DONE">DONE</span> [Long Connections] https://github.com/corelight/bro-long-connections](#long-connections-https-github-dot-com-corelight-bro-long-connections):Necessary:
        - <span class="section-num">5.4.2</span> [<span class="org-todo done DONE">DONE</span> [Connection Burst Identification] https://github.com/corelight/conn-burst](#connection-burst-identification-https-github-dot-com-corelight-conn-burst):Necessary:
    ...
    - <span class="section-num">5.6</span> [Zeek CVE Detection](#zeek-cve-detection)
        - <span class="section-num">5.6.1</span> [GitHub - corelight/CVE-2020-16898: A network detection package for CVE-2020-16898 (Windows TCP/IP Remote Code Execution Vulnerability)](#github-corelight-cve-2020-16898-a-network-detection-package-for-cve-2020-16898--windows-tcp-ip-remote-code-execution-vulnerability):windows:
        - <span class="section-num">5.6.2</span> [GitHub - 0xxon/cve-2020-0601: Zeek package to detect CVE-2020-0601](#github-0xxon-cve-2020-0601-zeek-package-to-detect-cve-2020-0601)
...
#### <span class="org-todo done DONE">DONE</span> <span class="section-num">5.3.1</span> [ ] [] <https://github.com/hhzzk/dns-tunnels> {#https-github-dot-com-hhzzk-dns-tunnels}


#### <span class="org-todo done DONE">DONE</span> <span class="section-num">5.3.2</span> [ ][dns axfr query ] <https://github.com/srozb/dns%5Faxfr> {#dns-axfr-query-https-github-dot-com-srozb-dns-axfr}
...
#### <span class="org-todo done DONE">DONE</span> <span class="section-num">5.3.3</span> <https://github.com/corelight/top-dns> {#https-github-dot-com-corelight-top-dns}
...
#### <span class="org-todo done DONE">DONE</span> <span class="section-num">5.4.1</span> [Long Connections] <https://github.com/corelight/bro-long-connections> {#long-connections-https-github-dot-com-corelight-bro-long-connections}


#### <span class="org-todo done DONE">DONE</span> <span class="section-num">5.4.2</span> [Connection Burst Identification] <https://github.com/corelight/conn-burst> {#connection-burst-identification-https-github-dot-com-corelight-conn-burst}
...
#### <span class="section-num">5.6.2</span> [GitHub - 0xxon/cve-2020-0601: Zeek package to detect CVE-2020-0601](https://github.com/0xxon/cve-2020-0601) {#github-0xxon-cve-2020-0601-zeek-package-to-detect-cve-2020-0601}
